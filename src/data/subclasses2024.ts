...
export const SUBCLASSES_2024: Record<string, SubclassDef[]> = {
  ...
  sorcerer: [
    ...
    },
    {
      ...
      features: [
        { id: 'wm-3', name: 'Oleada de magia salvaje', description: 'Al lanzar conjuros de hechicero de nivel 1+ puede activarse una oleada (tabla de efectos).', level: 3, source: 'subclass', actionType: 'passive' },
        { id: 'wm-3b', name: 'Mareas del caos', description: 'Puedes obtener ventaja en una tirada; la próxima vez el DM puede forzar oleada.', level: 3, source: 'subclass', actionType: 'special', uses: { max: 1, recovery: 'long' } },
        { id: 'wm-6', name: 'Bendición del caos', description: 'Cuando ocurre una oleada, recuperas SP.', level: 6, source: 'subclass', actionType: 'passive' },
        { id: 'wm-14', name: 'Manipular el caos', description: 'Puedes tirar dos veces en la tabla de oleada y elegir.', level: 14, source: 'subclass', actionType: 'passive' },
        { id: 'wm-18', name: 'Sobrecarga de caos', description: 'Gastas SP para forzar oleadas controladas o maximizar efectos aleatorios.', level: 18, source: 'subclass', actionType: 'special' },
      ],
    },
  ],
  warlock: [
